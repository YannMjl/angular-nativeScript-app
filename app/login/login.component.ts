...
export class LoginComponent implements OnInit {
    ...
    login() {
        if (getConnectionType() === connectionType.none) {
            alert("Report requires an internet connection to log in.");
            return;
        }
    ...
    signUp() {
        if (getConnectionType() === connectionType.none) {
            alert("Report requires an internet connection to register.");
            return;
        }
    ...
    forgotPassword() {
        prompt({
            ...
            message: "Enter the email address you used to register to view Reports to reset your password.",
            defaultText: "",
            okButtonText: "Ok",
